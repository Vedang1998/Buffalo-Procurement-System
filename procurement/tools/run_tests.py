...
REQUIRED_MODULE_MINIMUMS = {
    ...
    "test_phase4_published_production_reconciliation.py": 70,
    ...
    "test_supplier_mapping_review.py": 30,
    "test_supplier_format_conformance.py": 9,
    "test_supplier_pdf_extraction.py": 22,
